...
const Contact = () => {
    ...
    return (
        <div className="parallax">
                ...
                <div className="container">
                    <div className="git-cont row">
                        <div className="col-12 col-sm-6 half">
                            <form action={contact.contactUrl ? contact.contactUrl : "mailto:shafqatnadeem2@gmail.com"} method={contact.contactUrl ? "POST" : "GET"}>
            ...
            <p id="not-dark" className="Copy">2025 © Copyright <strong>{contact.copyright}</strong>. All Rights Reserved</p>
        </div>
    )
